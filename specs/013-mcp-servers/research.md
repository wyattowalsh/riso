...
1. Complex: `fetch_url` - async, error handling, timeout, retry logic

**Resource Examples**:

1. Simple: `about` - static JSON content, fixed MIME type
1. Complex: `file_browser` - dynamic directory listing, URI parameters, pagination

**Prompt Examples**:

1. Simple: `greeting` - single-turn, string template, basic parameters
1. Complex: `code_review` - multi-turn conversation, context injection, examples
