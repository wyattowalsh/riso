...
export const VALIDATION_RULES: ValidationRule[] = [
  ...
  // ========================================
  {
    ...
    message:
      "Clerk already includes enterprise SSO; WorkOS bridge is redundant",
    severity: "warning",
...

  {
    ...
    message:
      "Next.js 16 is optimized for Vercel; Cloudflare may have limited support",
    severity: "warning",
...

  {
    ...
    message:
      "Remix is optimized for Cloudflare; Vercel may have limited support",
    severity: "warning",
    affectedFields: ["saas_runtime", "saas_hosting"],
    quickFix: {
...

  {
    ...
    details:
      "App features like jobs, email, and storage require database infrastructure.",
  },

  {
    ...
    details:
      "OpenAPI docs are generated from API endpoints when docs are enabled.",
  },
...

  {
    ...
    check: (s) =>
      (s.api_features === "graphql" ||
        s.api_features === "graphql,websocket") &&
  ...
  // ========================================
  {
    ...
    check: (s) =>
      ...
      s.saas_billing_provider === "stripe",
...

  {
    ...
    check: (s) =>
      s.saas_billing_module === "enabled" &&
      s.saas_billing_provider === "paddle",
...

  {
    ...
    affectedFields: ["saas_analytics"],
    details:
      "Growth plan starts at $49/month. Best for product-led growth teams.",
  },
...

  {
    ...
    check: (s) =>
      s.project_layout === "monorepo" && s.shared_logic === "disabled",
...

  {
    ...
    check: (s) =>
      s.api_module === "enabled" && s.changelog_module === "disabled",
...

  {
    ...
    quickFix: {
      ...
      apply: (state) => ({
        api_languages: [...(state.api_languages || []), "python"],
      }),
    },
    details:
...

  {
    ...
    quickFix: {
      label: "Add Node API",
      apply: (state) => ({
        api_languages: [...(state.api_languages || []), "node"],
      }),
    },
    details:
      "TypeDoc generates documentation from TypeScript type annotations.",
  },
...

  {
    ...
    check: (s) => s.saas_hosting === "cloudflare" && s.saas_orm === "prisma",
...

  {
    ...
    check: (s) => s.saas_hosting === "vercel" && s.saas_orm === "drizzle",
    ...
    details:
      "Prisma has excellent Vercel integration with serverless optimization.",
  },

  {
    ...
    check: (s) =>
      ...
      s.saas_app_module !== "enabled",
    message:
      "Enable app layer for email notifications (verification, invoices)",
    severity: "info",
