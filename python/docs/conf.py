"""Sphinx configuration for Changelog Python (Shibuya theme)."""
...
PROJECT_SLUG = "changelog-python"
ORG_SLUG = "riso-template"
...
project = "Changelog Python Dev Docs"
author = "Riso Maintainer"
copyright = f"{date.today().year}, {author}"
version = os.getenv("CHANGELOG-PYTHON_VERSION", "0.1.0")
release = version
...
html_short_title = "Changelog Python Docs"
