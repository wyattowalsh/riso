...
from changelog_python.cli.__main__ import app, discover_commands, register_commands
...
class TestCommandDiscovery:
    ...
    def test_register_commands_adds_to_app(self, cli_runner: CliRunner) -> None:
        """Test that register_commands exposes commands on the Typer app."""
        register_commands()
...
class TestVersionCommand:
    ...
    def test_version_command_shows_version(self, cli_runner: CliRunner) -> None:
        ...
        assert result.exit_code == 0
        assert "Changelog Python" in result.stdout or "version" in result.stdout.lower()
...
class TestInitCommand:
    ...
    def test_init_command_with_force_overwrites(self, cli_runner: CliRunner, tmp_path: Path) -> None:
        ...
        assert result.exit_code == 0
        assert "Changelog Python" in config_file.read_text()
