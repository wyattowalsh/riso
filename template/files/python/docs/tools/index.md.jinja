...
{{ project_name }} ships automation to keep rendered projects deterministic and
well-governed.

- **Render scripts**: `scripts/render-samples.sh` (from the template) renders
  canonical variants and records smoke-test results.
...
- **Quality parity**: `scripts/ci/run_quality_suite.py` mirrors the justfile/Makefile and
