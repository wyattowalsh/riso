...
| **blocking reason** | —                                                                                                                                                   |
| **redacted log**    | 2026-08-18 official re-render exit 0. Docs smoke **passed** (20s). `robots.ts`/`sitemap.ts` ship `dynamic` + `revalidate`. No leftover `openspec/`. |
| **fix**             | none                                                                                                                                                |
| **evidence**        | official render log; `ASSURANCE.md`                                                                                                                 |
